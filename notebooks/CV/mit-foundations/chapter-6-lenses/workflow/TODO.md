...
| Status | Book ref | Output file | Strategy |
|---|---|---|---|
| ⬜ | Fig 6.6 | `images/fig06_06.png` | Synthesize. Off-axis source. Lens rotated by $\theta_R$, on-axis point $P_0$ and off-axis point $P_1$ imaged. |
| — | Fig 6.7 | — | Skip. Physical laser-pointer photo. Acknowledged in prose. |
| ⬜ | Fig 6.8 (a) | `images/fig06_08a.png` | Synthesize. Thick lens, ray through center. |
| ⬜ | Fig 6.8 (b) | `images/fig06_08b.png` | Synthesize. Thin lens, ray through center. |
| ⬜ | Fig 6.8 (c) | `images/fig06_08c.png` | Synthesize. Lens behaving as a pinhole. |
